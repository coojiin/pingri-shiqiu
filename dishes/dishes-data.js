...
window.PINGRI_I18N = {
  zh: {
    pageTitle: "菜品故事",
    brand: "平日食器",
    lead: "每道菜都有主名與副標：文藝一點，但點餐一眼看懂。外國朋友可切換語言，看「這是什麼」。",
    what: "這是什麼",
    story: "故事／說明",
    price: "價格",
    pendingPhoto: "菜圖準備中",
  ...
  en: {
    ...
    brand: "Pingri Shiqiu",
    lead: "Each dish has a poetic name plus a plain subtitle. Switch language to see what you’re ordering.",
    what: "What it is",
    story: "Story",
    price: "Price",
  ...
  ja: {
    pageTitle: "お品書きストーリー",
    brand: "平日食器",
    lead: "料理名は少し詩的、サブタイトルで中身が分かるように。言語を切り替えて「何の料理か」を確認できます。",
    what: "これは何か",
    story: "ストーリー",
    price: "価格",
    pendingPhoto: "写真準備中",
  ...
  ko: {
    pageTitle: "메뉴 이야기",
    brand: "평일식기",
    lead: "요리 이름은 조금 문학적, 부제로 무엇인지 바로 알 수 있어요. 언어를 바꿔 「이게 무슨 음식인지」 확인하세요.",
    what: "어떤 음식인가요",
    story: "이야기",
    price: "가격",
